...
Place files in the canvas root directory (default `~/openclaw/agents/eko/canvas/`):

```bash
cat > ~/openclaw/agents/eko/canvas/my-game.html << 'HTML'
<!DOCTYPE html>
<html>
...
```
http://<host>:18793/__openclaw__/canvas/index.html  → ~/openclaw/agents/eko/canvas/index.html
http://<host>:18793/__openclaw__/canvas/games/snake.html → ~/openclaw/agents/eko/canvas/games/snake.html
```
